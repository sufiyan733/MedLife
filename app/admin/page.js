...
const NAV = [
  { section: 'Navigation', items: [
    ...
    { key:'Staff', icon:'<path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>' },
  ]},
...
export default function AdminPage() {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      const keys = { '1':'Dashboard', '2':'Hospitals', '3':'Appointments', '4':'Users', '5':'Staff', '6':'Analytics', '7':'Network' };
