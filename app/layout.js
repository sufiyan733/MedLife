...
export const metadata = {
  ...
  keywords: "hospital finder, emergency hospital, bed availability, AI health assistant, MediLife, nearest hospital, appointment booking, symptom checker",
  openGraph: {
...
export default function RootLayout({ children }) {
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${dmSans.variable} ${sora.variable} h-full antialiased`}
    >
      <head>
