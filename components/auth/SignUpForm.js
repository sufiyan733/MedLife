  ...
  return (
    <>
      ...
      <p className="text-[13px] text-slate-400 mb-6">
        Join thousands of patients on MediLife
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5">
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-[0.4px] mb-1.5">First name</label>
            <input
              type="text" placeholder="Arjun" required
          ...
          <div>
            <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-[0.4px] mb-1.5">Last name</label>
            <input
        ...
        <div>
          <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-[0.4px] mb-1.5">Email</label>
          <input
        ...
        <div>
          <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-[0.4px] mb-1.5">Password</label>
          <input
            type="password" placeholder="Min. 8 characters" required minLength={8}
            value={form.password}
